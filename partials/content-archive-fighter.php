...
if(empty($current_page_info->slug)&&get_query_var('paged')==0){
	?>
	<section class="section-fighters">
		<div class="container">
			<header class="text-center margin-bottom-30">
				<h2 class="section-title"><strong class="text-black">Search  <span>Fighters</span></strong></h2>
			</header>
			<div class="row">
				<div class="col-sm-6 col-sm-offset-3">
					<div class="inline-search clearfix margin-bottom-30">
						<form action="<?=site_url('search')?>" method="get" class="widget_search">
							<input type="search" placeholder="Start Searching..." id="s" name="keyword" class="serch-input">
							<button type="submit">
			...
			<!-- <div class="text-center">
				<div class="owl-carousel nomargin" data-plugin-options='{"singleItem": false, "autoPlay": true}'>
					<div>
						<img class="img-responsive" src="<?=get_stylesheet_directory_uri()?>/assets/img/mma_class2.jpg" alt="">
					</div>
				</div>
			</div> -->
		</div>
