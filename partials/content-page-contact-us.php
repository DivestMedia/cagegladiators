...
<script>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCqCn84CgZN6o1Xc3P4dM657HIxkX3jzPY&callback=initMap"></script>
<?php
// wp_enqueue_script( 'isb_smarty.maps-script-google', '//maps.google.com/maps/api/js?key=AIzaSyCqCn84CgZN6o1Xc3P4dM657HIxkX3jzPY&callback=initMap', array( 'jquery' ), null, true );
// wp_enqueue_script( 'isb_smarty.swiper-script', get_template_directory_uri() . '/assets/plugins/gmaps.js', array( 'jquery' ), null, true );
// wp_enqueue_script( 'isb_smarty.main-script-assets', get_stylesheet_directory_uri() . '/assets/js/maps.js', array( 'jquery' ), null, true );
