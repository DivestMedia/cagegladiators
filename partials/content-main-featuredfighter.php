			...
			<div class="owl-carousel owl-padding-10 buttons-autohide controlls-over" data-plugin-options='{"singleItem": true, "items":"2", "autoPlay": false, "navigation": false, "pagination": false, "stopOnHover": true }' id="global-news-post-slider">
				<div class="figher-item">
					<img src="<?=site_url('/wp-content/uploads/2016/11/main-featured-fighter-2.png')?>" class="img-responsive"/>
						<div class="fighter-profile">
							<p class="text-white size-13 hidden-xs">Roman Canto is a boxer who’s been training practically his whole life. In fact, he a boxer for who boxing has been his whole life.</p>
				...
				<div class="figher-item">
					<img src="<?=site_url('/wp-content/uploads/2016/11/main-featured-fighter-3.png')?>" class="img-responsive"/>
						<div class="fighter-profile">
							<p class="text-white size-13 hidden-xs">Glen Ranillo has led an interesting and peripatetic life, with a few walkabouts and some ups and downs along the way. But, always, going through it all with his own trademark calm and laid-back demeanor.</p>
				...
				<div class="figher-item">
					<img src="<?=site_url('/wp-content/uploads/2016/11/main-featured-fighter-4.png')?>" class="img-responsive"/>
						<div class="fighter-profile">
							<p class="text-white size-13 hidden-xs">Eric was born on April 30, 1982, in Baguio, in the mountain province of Benguet, on the island of Luzon, this is where most of the good fighters come from, it’s practically in the genes up there. </p>
				...
				<div class="figher-item">
					<img src="<?=site_url('/wp-content/uploads/2016/11/main-featured-fighter-5.png')?>" class="img-responsive"/>
						<div class="fighter-profile">
							<p class="text-white size-13 hidden-xs">There are two Kelly brothers, both good fighters; Edward Kelly is the calmer one of the pair, or at least until he gets in the cage. Maybe it’s part of his proud Igorot spirit, something both brothers cherish.</p>
