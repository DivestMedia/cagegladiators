...
?>
	<section id="section-media-gallery">
		<div class="container">
			<div class="row">
				<!-- <div class="col-md-3 container-fighter-info">
				...
				<div class="col-md-9">
					<h3 class="header-red"><?=$fighter->post_title?> Media Gallery</h3>
                        ...
                        <div class="masonry-gallery columns-3 margin-bottom-20 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
                            <?php
